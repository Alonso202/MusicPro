...
function listaProductos(arregloProductos){
    ...
    for (let producto of arregloProductos){
        contenedor=contenedor+'<tr><td class="producto-col"><img src="'+producto.imagen+'"><div class="pc-title"><h4>'+producto.nombre+'</h4></div></td><td class="precio-col">$'+producto.valor+'</td></tr>'
    }
